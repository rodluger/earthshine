...
to many that data from the spacecraft could be used not only to detect Sol d but to
...
\todo{We find...} 
Future observations with \TESS will yield further information on 
the time variability of surface features on Sol d.

\todo{(habitability of Sol d, speculation on landing sites)}
