...
Not all postage stamps are equally informative, since the desired signal from Sol d is inhomogenously spread across the \TESS detectors and manifests differently in different regions (see \S\ref{sec:systematics}). 
...
in upcoming work once data from future \tess sectors becomes available.
