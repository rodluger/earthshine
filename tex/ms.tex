...
as a multiplicative term to scale from the intrinsic luminance \todo{(is this the right word??)} of Sol d to 
the flux observed by \TESS. The model for the flux timeseries
...
averaged over the 28 days of data analyzed in this work, smoothed it \todo{(how?)}, 
...
that it does not introduce significant bias.
