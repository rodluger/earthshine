...
d is close to full phase as seen by \tess.
...
and we have shown that this is true even when the solution is
known ahead of time. Presented with the top panel of Figure~\ref{fig:map}
(without the continent outlines),
an inhabitant of Sol d would be hard-pressed to identify that
...
simple fact that the reflectance of Sol d is dominated---by far---by clouds.

\todo{Discuss how this problem is *hard* and how we need
