...
\todo{Residuals in Figure~\ref{fig:model} display significant correlated
structure. Talk about their power spectrum. Temporal fit helps. Discuss
Figure~\ref{fig:map_temporal} and argue we have evidence for clouds.}
...
\subsection{Application to Other Planets}
\label{sec:otherplanets}

\todo{Discuss how we would we do this for an actual exoplanet, and
all the homework we need to do before that happens.}
