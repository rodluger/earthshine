...
cadences during which Sol d was below the edge of the sunshade, and
normalized them to the same min-max range. We then computed the median
flux at each cadence along with an estimate of the variance from the
median absolute deviation (MAD) across all light curves.
For each light curve, we then computed a score $\chi^2$ equal to the sum of the squares of the
...
of 75 and 20 light curves, respectively. Our final dataset consisted of
912,605 data points in total. 
