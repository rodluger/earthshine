...
Figure~\ref{fig:map} that degenaricies still abound. This is likely because
...
introduces significant correlated noise into the problem. We discuss
sources of bias in more detail in \S\ref{sec:bias} below
...
\todo{For realz, how would we do this.}
