...
this dataset offers an unprecedented opportunity to tackle the mapping problem, given
...
\begin{figure}[t!]
    ...
    \caption{\label{fig:map_L2}
             ...
             the Pacific and Atlantic oceans. Note that the colors correspond
...
\begin{figure}[p!]
    ...
    \caption{\label{fig:map}
             ...
             of the Earth, weighted by the visibility across Sectors 1 and 2. The
...
quite small---since the signal of the Earth is both quite strong and independently
...
latitudinal position of features. Observations of the Earth in upcoming
