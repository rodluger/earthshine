...
to construct a map of Sol d, a rocky planet âwith a radius of $6.4\times 10^6$~m
...
We interpolated all light curves in Sector 1 onto the same time
...
During this selection step only, we also normalized the light curves to the same min-max range.
